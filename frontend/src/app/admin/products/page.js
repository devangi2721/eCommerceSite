...
const CATEGORY_API_URL = 'http://localhost:5000/api/admin/categories';
...
export default function AdminProductsPage() {
  ...
  const handleEdit = (prod) => {
    setEditing(prod._id);
    setForm({ name: prod.name, price: prod.price, category: prod.category, image: prod.image });
    setShowModal(true);
  };
  ...
  return (
    <div className="mx-auto p-8 bg-white rounded-lg shadow-md">
      <h1 className="text-2xl font-bold text-purple-600 mb-6">Product Management</h1>
              ...
              products.map(prod => (
                ...
                >
                  <td className="py-3 px-6">
                    {prod.image && <img src={prod.image} alt={prod.name} className="w-16 h-16 object-cover rounded" />}
                  </td>
